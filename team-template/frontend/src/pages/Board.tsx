...
export default function Board() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-120px)]">
      ...
      {/* Filter Panel */}
      {showFilters && (
        <div className="flex flex-wrap gap-4 p-4 bg-gray-50 rounded-lg border mb-3 flex-shrink-0">
          <div>
      ...
      {showArchived && (
        <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200 mb-3 flex-shrink-0">
          <div className="flex items-center justify-between mb-3">
      ...
      {/* Activity Panel */}
      {showActivity && (
        <div className="p-4 bg-gray-50 rounded-lg border mb-3 flex-shrink-0">
          <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex-shrink-0 w-52 h-full">
            {showAddColumn ? (
              ...
              <button
                ...
                className="w-full h-full min-h-[100px] border-2 border-dashed border-gray-300 rounded-lg text-gray-500 hover:border-gray-400 hover:text-gray-600 text-sm"
              >
                + Add Column
              </button>
            )}
